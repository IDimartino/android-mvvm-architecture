...
import com.idima.app.mvvm.data.local.db.dao.OptionDao;
import com.idima.app.mvvm.data.local.db.dao.QuestionDao;
import com.idima.app.mvvm.data.local.db.dao.UserDao;
